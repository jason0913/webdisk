    ...
    <div class="login">
        <div class="col-lg-10">
            ...
            <div class="input-group m-top20">
                ...
                <input type="password" name="passWord" id="passWord" placeholder="<?php echo t('用户密码'); ?>" class="logininput form-control input-lg">
            </div>
        </div>
        <div class="col-lg-10">
            <div class="checkbox">
                <label id="rem">
                        <input type="checkbox" id="remember" name="remember" checked="checked"> <?php echo t('记住登录状态'); ?>
                </label>
                <label id="forget" style="margin-left: 160px;">
                        <input type="checkbox" id="forget" name="forget" checked="checked"> <?php echo t('忘了密码'); ?>
                </label>
            </div>
        </div>
        <div class="col-lg-10">
